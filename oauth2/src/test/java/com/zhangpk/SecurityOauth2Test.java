...
public class SecurityOauth2Test {
    ...
    public void getUserInfo(){
        ...
        ResponseEntity<String> result = rest.exchange(USER_INFO_URI, HttpMethod.GET, httpEntity, String.class, new Object[]{null});
    ...
    /**
     * 构建header
     * 可以看出格式为clientId:clientSecret格式进行base64转码后加前缀Basic
     *
     * @return
     */
