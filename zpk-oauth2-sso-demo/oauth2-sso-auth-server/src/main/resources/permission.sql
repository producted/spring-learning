...
CREATE TABLE `oauth_client_details` (
  `client_id` varchar(128) CHARACTER SET utf8 NOT NULL,
  `resource_ids` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `client_secret` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `scope` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `authorized_grant_types` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `web_server_redirect_uri` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `authorities` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `access_token_validity` int(11) DEFAULT NULL,
  `refresh_token_validity` int(11) DEFAULT NULL,
  `additional_information` varchar(4096) CHARACTER SET utf8 DEFAULT NULL,
  `autoapprove` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
...
BEGIN;
INSERT INTO `permission`.`sys_permission` (`id`, `pid`, `type`, `name`, `code`, `uri`, `seq`, `create_user`, `create_time`, `update_user`, `update_time`) VALUES ('2', '0', '3', 'list', 'member:detail', '/member/detail', '1', 'system', NULL, 'system', NULL);
INSERT INTO `permission`.`sys_permission` (`id`, `pid`, `type`, `name`, `code`, `uri`, `seq`, `create_user`, `create_time`, `update_user`, `update_time`) VALUES ('2', '0', '3', 'list', 'member:detail', '/member/detail', '1', 'system', NULL, 'system', NULL);
COMMIT;